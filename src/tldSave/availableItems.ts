...
const availableItems: ItemInfo[] = [
  ...
  ...new Array(11).map((v, i) => createCollectible(`GEAR_DarkwalkerDiary${i + 1})`)),
  createCollectible('GEAR_DarkwalkerID'),
  ...new Array(5).map((v, i) => createCollectible(`GEAR_DeadmanNote${i + 1})`)),
  ...
  ...new Array(6).map((v, i) => createCollectible(`GEAR_EP3_PatientHistory0${i + 1})`)),
  ...new Array(3).map((v, i) => createCollectible(`GEAR_Ep3ForestTalkers_FTCollectible${i + 1})`)),
  ...new Array(3).map((v, i) => createCollectible(`GEAR_Ep3ForestTalkers_PVCollectible${i + 1})`)),
  ...
  ...new Array(3).map((v, i) => createCollectible(`GEAR_Ep4_LetterForestTalker${i + 1})`)),
  ...
  ...new Array(3).map((v, i) => createCollectible(`GEAR_KnowledgeBRbook${i + 1})`)),
  createCollectible('GEAR_KnowledgeCarterDam'),
  ...new Array(4).map((v, i) => createCollectible(`GEAR_KnowledgeCollapse${i + 1})`)),
  createCollectible('GEAR_KnowledgeMilton'),
  createCollectible('GEAR_KnowledgeMysteryLake'),
  ...new Array(3).map((v, i) => createCollectible(`GEAR_KnowledgePVbook${i + 1})`)),
  ...new Array(3).map((v, i) => createCollectible(`GEAR_LakeCabinKey${i + 1})`)),
  ...
  ...new Array(3).map((v, i) => createCollectible(`GEAR_MiltonDepositBoxKey${i + 1})`)),
  ...
  ...new Array(10).map((v, i) => createCollectible(`GEAR_PlaneCrashID${i + 1})`)),
