...
export default interface PlayerManagerSaveDataProxy {
  m_SaveGamePosition?: [number, number, number] | null;
  m_SaveGameRotation?: [number, number, number, number] | null;
  ...
  m_FatigueBuffCauseLocID?: string | null;
